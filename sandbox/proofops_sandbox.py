#!/usr/bin/env python3
"""Portable command sandbox for proofops-toolkit agents.
...
def health_check(args: argparse.Namespace) -> None:
    request = urllib.request.Request(args.url, headers={"User-Agent": "proofops-sandbox/1"})
    try:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="proofops-toolkit sandbox")
