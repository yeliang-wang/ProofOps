...
def build_catalog() -> tuple[dict, dict]:
    ...
    return (
        {"schema": "proofops-agent-catalog/v1", "agentCount": len(agent_entries), "agents": agent_entries},
        {"schema": "proofops-plugin-catalog/v1", "pluginCount": len(plugin_entries), "plugins": plugin_entries},
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate ProofOps catalogs")
